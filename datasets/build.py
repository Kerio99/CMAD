...
def build_dataset(data_name, data_path, normal_json_path, outlier_json_path, transform, shot, modality, split, layer_list):
    """
    ...
    return DATASET_REGISTRY.get(name)(data_path, normal_json_path, outlier_json_path, transform, shot, modality, split, layer_list)
