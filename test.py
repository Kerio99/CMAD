...
def parse_args():
    ...
    parser.add_argument("--test_dataset_name", default="", type=str, help="test dataset_name")
    parser.add_argument("--output_result_file", default="", type=str, help="output result_file")
    parser.add_argument("--modality", default="rgb", type=str, help="modality")
    parser.add_argument("--prototype_list_path", default="./prototype_list.pt", type=str, help="path to prototype list pt")
    parser.add_argument(
        "--data_processed_json_root",
        default="./data_processed_json",
        type=str,
        help="root directory for processed json files",
    )
...
def load_config(args):
    ...
    if hasattr(args, "test_dataset_name"):
        cfg.test_dataset_name = args.test_dataset_name
        
    if hasattr(args, "output_result_file"):
        cfg.output_result_file = args.output_result_file

    if hasattr(args, "modality"):
        cfg.modality = args.modality
    if hasattr(args, "prototype_list_path"):
        cfg.prototype_list_path = args.prototype_list_path

    if hasattr(args, "data_processed_json_root"):
        cfg.data_processed_json_root = args.data_processed_json_root
